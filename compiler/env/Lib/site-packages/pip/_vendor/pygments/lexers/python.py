...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'expr': [
            ...
            (r'!=|==|<<|>>|:=|[-~+/*%=<>&^|.]', Operator),
            (r'[]{}:(),;[]', Punctuation),
            (r'(in|is|and|or|not)', Operator.Word),
        ...
        'expr-keywords': [
            ...
            (words((
                ...
                'yield', 'yield from'), suffix=r''),
             Keyword),
            (words(('True', 'False', 'None'), suffix=r''), Keyword.Constant),
        ],
        'keywords': [
            (words((
        ...
        'soft-keywords': [
            ...
            (r'(^[ \t]*)'              # at beginning of line + possible indentation
             r'(match|case)'         # a possible keyword
             r'(?![ \t]*(?:'           # not followed by...
             r'[:,;=^&|@~)\]}]|(?:' +  # characters and keywords that mean this isn't
             r'|'.join(keyword.kwlist) + r')))',                 # pattern matching
             bygroups(Text, Keyword), 'soft-keywords-inner'),
        ],
        'soft-keywords-inner': [
            # optional `_` keyword
            (r'(\s+)([^\n_]*)(_)', bygroups(Text, using(this), Keyword)),
            default('#pop')
        ],
        'builtins': [
            (words((
                ...
                'type', 'vars', 'zip'), prefix=r'(?<!\.)', suffix=r''),
             Name.Builtin),
            (r'(?<!\.)(self|Ellipsis|NotImplemented|cls)', Name.Builtin.Pseudo),
            (words((
        ...
        'magicvars': [
            (words((
                ...
                '__self__', '__slots__', '__weakref__'), suffix=r''),
             Name.Variable.Magic),
        ],
        'numbers': [
        ...
        'fromimport': [
            (r'(\s+)(import)', bygroups(Text, Keyword.Namespace), '#pop'),
            (r'\.', Name.Namespace),
            # if None occurs here, it's "raise x from None", since None can
            # never be a module name
            (r'None', Name.Builtin.Pseudo, '#pop'),
            (uni_name, Name.Namespace),
            default('#pop'),
        ],
        'rfstringescape': [
    ...
    tokens = {
        ...
        'builtins': [
            ...
            (words((
                ...
                'WindowsError', 'ZeroDivisionError'), prefix=r'(?<!\.)', suffix=r''),
             Name.Exception),
        ],
        'magicfuncs': [
            (words((
        ...
        'fromimport': [
            (r'(?:[ \t]|\\\n)+', Text),
            (r'import', Keyword.Namespace, '#pop'),
            # if None occurs here, it's "raise x from None", since None can
            # never be a module name
            (r'None', Name.Builtin.Pseudo, '#pop'),
    ...
    tokens = {
        ...
        'keywords': [
            (words((
                ...
                'raise', 'return', 'try', 'while', 'yield', 'as', 'with'), suffix=r''),
             Keyword),
            (r'(DEF|IF|ELIF|ELSE)', Comment.Preproc),
        ],
        'builtins': [
            (words((
                ...
                'vars', 'xrange', 'zip'), prefix=r'(?<!\.)', suffix=r''),
             Name.Builtin),
            ...
            (words((
                ...
                'ZeroDivisionError'), prefix=r'(?<!\.)', suffix=r''),
             Name.Exception),
        ],
        'numbers': [
        ...
        'cdef': [
            (r'(public|readonly|extern|api|inline)', Keyword.Reserved),
            (r'(struct|enum|union|class)', Keyword),
            (r'([a-zA-Z_]\w*)(\s*)(?=[(:#=]|$)',
        ...
        'fromimport': [
            (r'(\s+)(c?import)', bygroups(Text, Keyword), '#pop'),
            (r'[a-zA-Z_.][\w.]*', Name.Namespace),
...
class DgLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r"`\w+'*`", Operator),
            (r'(and|in|is|or|where)', Operator.Word),
            (r'[!$%&*+\-./:<-@\\^|~;,]+', Operator),
